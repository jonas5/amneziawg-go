...
public class TunnelDetailPeerBindingImpl extends TunnelDetailPeerBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((org.amnezia.awg.config.Peer) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable org.amnezia.awg.config.Peer Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        java.util.Optional<org.amnezia.awg.config.InetEndpoint> itemEndpoint = null;
        boolean itemPreSharedKeyIsPresent = false;
        org.amnezia.awg.config.Peer item = mItem;
        boolean ItemPreSharedKeyIsPresent1 = false;
        org.amnezia.awg.crypto.Key itemPublicKey = null;
        ...
        java.util.Optional<org.amnezia.awg.crypto.Key> itemPreSharedKey = null;
        ...
        java.util.Set<org.amnezia.awg.config.InetNetwork> itemAllowedIps = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            org.amnezia.awg.databinding.BindingAdapters.setInetNetworkSetText(this.allowedIpsText, itemAllowedIps);
            ...
            org.amnezia.awg.databinding.BindingAdapters.setOptionalText(this.endpointText, itemEndpoint);
