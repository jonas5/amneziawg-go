...
public class TvActivityBindingImpl extends TvActivityBinding  {
    ...
    // variables
    // values
    private org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.activity.TvMainActivity.KeyedFile> mOldFiles;
    private int mOldAndroidLayoutTvFileListItem;
    private org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldFilesRowConfigurationHandler;
    ...
    private org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldTunnelRowConfigurationHandler;
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.filesRoot == variableId) {
            ...
            setFiles((org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.activity.TvMainActivity.KeyedFile>) variable);
        }
        else if (BR.filesRowConfigurationHandler == variableId) {
            setFilesRowConfigurationHandler((org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
            ...
            setTunnelRowConfigurationHandler((org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFiles(@Nullable org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.activity.TvMainActivity.KeyedFile> Files) {
    ...
    public void setFilesRowConfigurationHandler(@Nullable org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler FilesRowConfigurationHandler) {
    ...
    public void setTunnelRowConfigurationHandler(@Nullable org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler TunnelRowConfigurationHandler) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeFiles((org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.activity.TvMainActivity.KeyedFile>) object, fieldId);
            case 2 :
    ...
    private boolean onChangeFiles(org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.activity.TvMainActivity.KeyedFile> Files, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.activity.TvMainActivity.KeyedFile> files = mFiles;
        ...
        org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> filesRowConfigurationHandler = mFilesRowConfigurationHandler;
        ...
        org.amnezia.awg.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> tunnelRowConfigurationHandler = mTunnelRowConfigurationHandler;
        ...
        if ((dirtyFlags & 0x52L) != 0) {
            ...
            org.amnezia.awg.databinding.BindingAdapters.setItems(this.filesList, this.mOldFiles, this.mOldAndroidLayoutTvFileListItem, this.mOldFilesRowConfigurationHandler, files, R.layout.tv_file_list_item, filesRowConfigurationHandler);
        }
        if ((dirtyFlags & 0x49L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x68L) != 0) {
            ...
            org.amnezia.awg.databinding.BindingAdapters.setItems(this.tunnelList, this.mOldTunnels, this.mOldAndroidLayoutTvTunnelListItem, this.mOldTunnelRowConfigurationHandler, tunnels, R.layout.tv_tunnel_list_item, tunnelRowConfigurationHandler);
        }
        if ((dirtyFlags & 0x52L) != 0) {
