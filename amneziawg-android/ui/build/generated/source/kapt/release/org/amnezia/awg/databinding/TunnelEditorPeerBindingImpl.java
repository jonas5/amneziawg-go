...
public class TunnelEditorPeerBindingImpl extends TunnelEditorPeerBinding implements org.amnezia.awg.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener allowedIpsTextandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // item
            org.amnezia.awg.viewmodel.PeerProxy item = mItem;
            // item != null
    ...
    private TunnelEditorPeerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new org.amnezia.awg.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((org.amnezia.awg.viewmodel.PeerProxy) variable);
        }
            ...
            setCollection((androidx.databinding.ObservableList<org.amnezia.awg.viewmodel.PeerProxy>) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable org.amnezia.awg.viewmodel.PeerProxy Item) {
    ...
    public void setCollection(@Nullable androidx.databinding.ObservableList<org.amnezia.awg.viewmodel.PeerProxy> Collection) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((org.amnezia.awg.viewmodel.PeerProxy) object, fieldId);
            case 1 :
                return onChangeCollection((androidx.databinding.ObservableList<org.amnezia.awg.viewmodel.PeerProxy>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(org.amnezia.awg.viewmodel.PeerProxy Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCollection(androidx.databinding.ObservableList<org.amnezia.awg.viewmodel.PeerProxy> Collection, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7f9L) != 0) {
            ...
            if ((dirtyFlags & 0x421L) != 0) {
                    ...
                    bindingAdaptersTryParseIntItemPersistentKeepalive = org.amnezia.awg.databinding.BindingAdapters.tryParseInt(itemPersistentKeepalive);
        ...
        if ((dirtyFlags & 0x400L) != 0) {
            ...
            org.amnezia.awg.databinding.BindingAdapters.setFilter(this.preSharedKeyText, org.amnezia.awg.widget.KeyInputFilter.newInstance());
            ...
            org.amnezia.awg.databinding.BindingAdapters.setFilter(this.publicKeyText, org.amnezia.awg.widget.KeyInputFilter.newInstance());
        ...
        if ((dirtyFlags & 0x404L) != 0) {
            ...
            org.amnezia.awg.databinding.BindingAdapters.setOnFocusChange(this.preSharedKeyText, fragmentOnKeyFocusChangeAndroidViewViewOnFocusChangeListener);
        }
        if ((dirtyFlags & 0x411L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        ...
        public OnClickListenerImpl setValue(org.amnezia.awg.fragment.TunnelEditorFragment value) {
            this.value = value;
