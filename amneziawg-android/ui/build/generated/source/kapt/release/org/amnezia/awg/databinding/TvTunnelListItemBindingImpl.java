...
public class TvTunnelListItemBindingImpl extends TvTunnelListItemBinding  {
    ...
    // views
    @NonNull
    private final org.amnezia.awg.widget.TvCardView mboundView0;
    // variables
    // values
    // listeners
    ...
    private TvTunnelListItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.mboundView0 = (org.amnezia.awg.widget.TvCardView) bindings[0];
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x44L) != 0) {
            ...
            org.amnezia.awg.databinding.BindingAdapters.setIsDeleting(this.mboundView0, isDeletingGet);
            this.tunnelTransfer.setVisibility(isDeletingViewGONEViewVISIBLE);
        }
        if ((dirtyFlags & 0x51L) != 0) {
            // api target 1

            org.amnezia.awg.databinding.BindingAdapters.setIsUp(this.mboundView0, itemStateStateUP);
        }
        if ((dirtyFlags & 0x46L) != 0) {
            // api target 1
