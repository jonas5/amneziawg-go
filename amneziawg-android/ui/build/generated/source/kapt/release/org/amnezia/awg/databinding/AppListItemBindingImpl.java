...
public class AppListItemBindingImpl extends AppListItemBinding implements org.amnezia.awg.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener selectedCheckboxandroidCheckedAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // item
            org.amnezia.awg.model.ApplicationData item = mItem;
            // item != null
    ...
    private AppListItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new org.amnezia.awg.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((org.amnezia.awg.model.ApplicationData) variable);
        }
        else if (BR.collection == variableId) {
            setCollection((org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.model.ApplicationData>) variable);
        }
    ...
    public void setItem(@Nullable org.amnezia.awg.model.ApplicationData Item) {
    ...
    public void setCollection(@Nullable org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.model.ApplicationData> Collection) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((org.amnezia.awg.model.ApplicationData) object, fieldId);
            case 1 :
                return onChangeCollection((org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.model.ApplicationData>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(org.amnezia.awg.model.ApplicationData Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCollection(org.amnezia.awg.databinding.ObservableKeyedArrayList<java.lang.String,org.amnezia.awg.model.ApplicationData> Collection, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
